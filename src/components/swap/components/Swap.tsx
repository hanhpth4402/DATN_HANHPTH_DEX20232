...
import ShuffleIcon from "@/src/assets/icons/shuffleIcon";
import {ApproveState, useApprove} from "@/src/components/addLiquidity/useApprove";
import Button from "react-bootstrap/Button";
import FooterSwapForm from "@/src/components/swap/components/footerSwapForm";
import {useAccount, useChainId, useProvider, useSigner} from "wagmi";
import useActionSwap from "@/src/state/swap/useActionSwap";
import {useEffect, useMemo, useState} from "react";
import {RouteChiHang, RouteUniswap} from "@/src/config/configRoute";
import {useSelector} from "react-redux";
import useSwapType0 from "@/src/components/swap/useSwapType0";
import {abiERC20, abiRouteChiHang} from "@/src/config/abi";

import BigNumber from "bignumber.js";
import useAmount from "@/src/components/addLiquidity/hooks/useAmount";
